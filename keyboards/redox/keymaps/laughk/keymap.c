...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
     ...
     KC_LSFT ,KC_Z    ,KC_X    ,KC_C    ,KC_V    ,KC_B    ,LALT(KC_GRV),KC_PSCREEN,        KC_PGDN,KC_PGUP ,KC_N   ,KC_M    ,KC_COMM ,KC_DOT  ,KC_SLSH  ,KC_RSFT ,
     MO(_NAV),KC_PPLS ,KC_LANG1 ,KC_LALT ,  KC_LGUI,      KC_SPC,KC_TAB,                  KC_BSPC,KC_ENT  ,    KC_ENT      ,KC_EQL  ,KC_LBRC ,KC_RBRC  ,MO(_ADJUST)
  ),
