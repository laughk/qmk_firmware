 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  ~L1 | LGui | LAlt | ESC  | LANG1|                                      |   `  |   =  |  [   |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        | PgDn | PgUp |       | DEL  |Ctrl/Esc|
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      |PrtScr|       | RCTL |        |      |
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        MO(SYMB),       KC_LGUI,      KC_LALT,  KC_ESC, KC_LANG1,
                                                KC_PGDN, KC_PGUP,
                                                             KC_PSCREEN,
        ...
        KC_RBRC,     KC_N,   KC_M,   KC_COMM,  KC_DOT,  KC_SLSH,    KC_RSFT,
                             KC_GRV, KC_EQL,   KC_LBRC, KC_RBRC,    MO(SYMB),
        KC_DEL,        CTL_T(KC_ESC),
        KC_RCTRL,
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_TRNS,  KC_LEFT, KC_NO,   KC_RGHT, KC_TRNS,
                         KC_TRNS,  KC_TRNS, KC_DOWN, KC_LSFT, KC_TRNS,
       RGB_TOG, RGB_SLD,
       RGB_HUI,
