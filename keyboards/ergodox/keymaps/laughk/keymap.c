 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  ~L1 |AltTAB| LGui | LAlt | LANG1|                                      |LANG2 |   =  |  [   |   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
 *                                        | PgDn | PgUp |       | HOME |   END  |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        MO(SYMB),       LALT(KC_TAB), KC_LGUI,  KC_LALT,  KC_LANG1,
                                                KC_PGDN, KC_PGUP,
                                                             KC_PSCREEN,
                                                KC_SPC, KC_TAB, KC_NO,
        // right hand
        ...
        KC_RBRC,     KC_N,   KC_M,     KC_COMM,  KC_DOT,  KC_SLSH,    KC_RSFT,
                             KC_LANG2, KC_EQL,   KC_LBRC, KC_RBRC,    MO(SYMB),
        KC_HOME,    KC_END,
        KC_INSERT,
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_PGUP,  KC_LEFT, KC_NO,   KC_RGHT, KC_TRNS,
                         KC_PGDN,  KC_TRNS, KC_DOWN, KC_LSFT, KC_TRNS,
       RGB_TOG, RGB_SLD,
       RGB_HUI,
       RGB_HUD, KC_DEL,  KC_INSERT
),
